        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前的路由跳转：从A路由跳转到B路由，这里的加入购物车，进行路由跳转之前，发请求把你购买的产品信息通过请求的形式通知服务器，服务器进行相应的存储 -->
...
export default {
  ...
  methods:{
    ...
    // 添加购物车
    async addShopCar(){
      // 1.在点击加入购物车这个按钮的时候，做的第一件事情，将参数带给服务器，通知服务器加入购物车的产品是什么
      /*
        this.$store.dispatch('addOrUpdateShopCart'),这里其实是调用vuex中addOrUpdateShopCart函数
      */
      try{
        // 成功
        ...
        // 产品信息的数据【比较复杂：skuInfo】，通过绘画存储（不持久化，会话结束数据消失）
        // 本地存储|会话存储 ，一般存储的是字符串
      ...
      // 2.你徐璈知道这次请求成功还是失败，如果成功进行路由跳转，如果失败，需要给用户提示
